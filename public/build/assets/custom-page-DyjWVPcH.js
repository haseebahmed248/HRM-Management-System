import{R,j as o}from"./ui-ByQZYeaT.js";import{d as z,H as A}from"./app-02p5Ipaz.js";import F from"./Header-BKmtQmLF.js";import T from"./Footer-DovNHFuH.js";import{u as $}from"./use-favicon-DmFHib5i.js";/* empty css            *//* empty css                  */import"./utils-BWxnHGCV.js";import"./menu-B9EHK9wu.js";import"./mail-DkwVcI60.js";import"./phone-B6e6KkmI.js";import"./map-pin-B65w-cGl.js";import"./instagram-9Oz1Qny8.js";import"./twitter-D3nrreQd.js";function Z(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,i=l.props.globalSettings;R.useEffect(()=>{const r=(i==null?void 0:i.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=i==null?void 0:i.layoutDirection;(s==="left"||s==="right")&&(c=s)}const n=c==="right"?"rtl":"ltr";document.documentElement.dir=n,document.documentElement.setAttribute("dir",n),setTimeout(()=>{document.documentElement.getAttribute("dir")!==n&&(document.documentElement.dir=n,document.documentElement.setAttribute("dir",n))},1)},[]);const I=`
