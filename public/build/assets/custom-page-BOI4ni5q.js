import{R,j as o}from"./ui-ByQZYeaT.js";import{d as z,H as A}from"./app-Q5xnyLqF.js";import F from"./Header-tpTLvF9u.js";import T from"./Footer-DqIn1k49.js";import{u as $}from"./use-favicon-BJXaK8Kd.js";/* empty css            *//* empty css                  */import"./utils-BWxnHGCV.js";import"./menu-CtVdQjpm.js";import"./mail-DW5cJbwS.js";import"./phone-Bwp151Rg.js";import"./map-pin-CwsWWYYi.js";import"./instagram-TlGGjVqj.js";import"./twitter-BwJ6Q8zi.js";function Z(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,i=l.props.globalSettings;R.useEffect(()=>{const r=(i==null?void 0:i.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=i==null?void 0:i.layoutDirection;(s==="left"||s==="right")&&(c=s)}const n=c==="right"?"rtl":"ltr";document.documentElement.dir=n,document.documentElement.setAttribute("dir",n),setTimeout(()=>{document.documentElement.getAttribute("dir")!==n&&(document.documentElement.dir=n,document.documentElement.setAttribute("dir",n))},1)},[]);const I=`
