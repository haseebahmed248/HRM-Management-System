import{R,j as o}from"./ui-ByQZYeaT.js";import{d as z,H as A}from"./app-BB45jBwY.js";import F from"./Header-B6oACm4u.js";import T from"./Footer-D0u_ukER.js";import{u as $}from"./use-favicon-ZYOVcpp4.js";/* empty css            *//* empty css                  */import"./utils-BWxnHGCV.js";import"./menu-BiqV_eAP.js";import"./mail-C7Ayo7GR.js";import"./phone-TuISsaxl.js";import"./map-pin-Dc4JW-6j.js";import"./instagram-B6fD0HQP.js";import"./twitter-D5Z_-Hjh.js";function Z(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,i=l.props.globalSettings;R.useEffect(()=>{const r=(i==null?void 0:i.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=i==null?void 0:i.layoutDirection;(s==="left"||s==="right")&&(c=s)}const n=c==="right"?"rtl":"ltr";document.documentElement.dir=n,document.documentElement.setAttribute("dir",n),setTimeout(()=>{document.documentElement.getAttribute("dir")!==n&&(document.documentElement.dir=n,document.documentElement.setAttribute("dir",n))},1)},[]);const I=`
