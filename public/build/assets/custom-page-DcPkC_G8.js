import{R,j as o}from"./ui-ByQZYeaT.js";import{d as z,H as A}from"./app-DlVmVz4B.js";import F from"./Header-CNIFUCcD.js";import T from"./Footer-Gms8Kky3.js";import{u as $}from"./use-favicon-BuFiccMa.js";/* empty css            *//* empty css                  */import"./utils-BWxnHGCV.js";import"./menu-D0b3N7ui.js";import"./mail-Bnojx68D.js";import"./phone-AI2XX8Gz.js";import"./map-pin-C3j1cRuv.js";import"./instagram-YSdhig1I.js";import"./twitter-CZBlV6gN.js";function Z(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,i=l.props.globalSettings;R.useEffect(()=>{const r=(i==null?void 0:i.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=i==null?void 0:i.layoutDirection;(s==="left"||s==="right")&&(c=s)}const n=c==="right"?"rtl":"ltr";document.documentElement.dir=n,document.documentElement.setAttribute("dir",n),setTimeout(()=>{document.documentElement.getAttribute("dir")!==n&&(document.documentElement.dir=n,document.documentElement.setAttribute("dir",n))},1)},[]);const I=`
