import{R,j as o}from"./ui-ByQZYeaT.js";import{d as z,H as A}from"./app-_FZIJgvU.js";import F from"./Header-BjyaB-04.js";import T from"./Footer-cgyiPE5M.js";import{u as $}from"./use-favicon-CUKghgD6.js";/* empty css            *//* empty css                  */import"./utils-BWxnHGCV.js";import"./menu-D3as4gyt.js";import"./mail-CumJnqtI.js";import"./phone-78VwkzTM.js";import"./map-pin-Dgl0-K9o.js";import"./instagram-Bfv-alRx.js";import"./twitter-Dh0ZqOoW.js";function Z(){var u,f,h,x,g,b,y,j,_,v,C,N,k;const l=z(),{page:t,customPages:P=[],settings:e}=l.props,i=l.props.globalSettings;R.useEffect(()=>{const r=(i==null?void 0:i.is_demo)||!1;let c="left";if(r){const m=(H=>{var E;if(typeof document>"u")return null;const w=`; ${document.cookie}`.split(`; ${H}=`);if(w.length===2){const D=(E=w.pop())==null?void 0:E.split(";").shift();return D?decodeURIComponent(D):null}return null})("layoutPosition");(m==="left"||m==="right")&&(c=m)}else{const s=i==null?void 0:i.layoutDirection;(s==="left"||s==="right")&&(c=s)}const n=c==="right"?"rtl":"ltr";document.documentElement.dir=n,document.documentElement.setAttribute("dir",n),setTimeout(()=>{document.documentElement.getAttribute("dir")!==n&&(document.documentElement.dir=n,document.documentElement.setAttribute("dir",n))},1)},[]);const I=`
