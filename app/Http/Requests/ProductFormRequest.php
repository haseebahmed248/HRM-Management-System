...
class ProductFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'featured_image' => 'nullable|file|image|mimes:jpeg,png,jpg,gif,webp,avif|max:2048',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'featured_image.mimes' => 'The featured image must be a file of type: jpeg, png, jpg, gif, webp, avif.',
