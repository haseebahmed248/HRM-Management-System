...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(config('app.name', 'AfriPay HR')); ?></title>
...
<body>
    <div class="container">
        ...
        <div class="logo-wrapper">
            <div class="logo">
                <img src="<?php echo e(asset('images/logos/Afripay HR Logo_page-0001.jpg')); ?>" alt="<?php echo e(config('app.name', 'AfriPay HR')); ?>">
            </div>
        </div>
        ...
        <div class="footer">
            <div class="footer-badge">
                <?php echo e(config('app.name', 'AfriPay HR')); ?> • A product of Aromerc & Co. Ltd
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/haseeb/Downloads/FileSharing/fileshare-next/hrm-management-system/resources/views/errors/layout.blade.php ENDPATH**/ ?>